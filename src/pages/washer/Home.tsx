...
export default function Home() {
  ...
  useEffect(() => {
    ...
    async function load() {
      ...
      try {
        ...
        const [jobsRes, attendanceRes, payoutsRes] = await Promise.all([
        ...
        setAttendance((attendanceRes.data as AttendanceRecord | null) ?? null);
  ...
  return (
    <div className="px-4 pt-6 pb-4 space-y-4">
      ...
      <div className="rounded-2xl bg-gray-100 px-4 py-4 flex items-center justify-between gap-3">
        ...
        {!isCheckedIn && (
          <button
            ...
            disabled={checkingIn}
            className="rounded-full bg-blue-600 hover:bg-blue-700 disabled:opacity-50 text-white text-sm font-bold px-4 py-2 shrink-0"
          >
